  ...
  return (
    <section className=" lg:px-[60px] py-10 bg-white rounded-[5px]">
      <div className="bg-[#203553] lg:bg-white pt-8 pb-8 pr-5 pl-0 flex flex-col justify-between gap-2.5 mb-2">
        {number && (
          <span className="text-white lg:hidden block">{number}</span>
        )}
        ...
        >
          {coursesData[activeTab].cards.map((card, idx) => {
            ...
            return (
              ...
              >
                {/* Text + CTA */}
                <div className="joine-courses-text-container bg-[#FFF6F6] px-3 py-2 xl:px-[8px] xl:py-[4px] xl:gap-2.5 w-full transition-all duration-500">
                  <div>
                    <h2
